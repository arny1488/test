...
const WSS_SYSTEM_AUTH = '';

const DB_DATETIME_FORMAT = 'Y-m-d H:i:s';

const AUTH_TOKEN_LIFETIME = 300;

const REFRESH_TOKEN_LIFETIME = 1_209_600;

const VERIFICATION_CODE_LIFETIME = 120;
...
const SQL_CACHE_LIFETIME = 0;

const PROFILING = false;

const HTML_COMPRESSION = true;

const GZIP_COMPRESSION = false;
