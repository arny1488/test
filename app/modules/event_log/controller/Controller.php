...
class EventLogController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $files = [
            ...
            ABS_PATH . 'assets/vendors/datatables.net/dataTables.responsive.js',
            ABS_PATH . 'assets/vendors/datatables.net/responsive.bootstrap5.js',
    ...
    {
        if (($event_log = Log::get()) && !empty($event_log)) {
            File::download_string(Arrays::toCSV($event_log), 'text/csv', 'log.csv');
        }
    }
