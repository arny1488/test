...
class DashboardController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // Add dependencies
        $files = [
            ABS_PATH . 'assets/vendors/moment/moment-with-locales.min.js',
    ...
    public function index()
    {
        ...
        $Template
            ->assign('data', $data)
            ->assign('user', (defined('USERID') && USERID) ? TM4RENT\User::get(USERID, ORGID) : null)
            ->assign('organization', (defined('ORGID') && ORGID) ? TM4RENT\Organization::get(ORGID) : null)
           // ->assign('fgis_available', FGIS\Status::getAvailability())
