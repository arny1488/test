...
class UsersController extends Controller
{
     ...
     */
    public function view(string $user_id): void
    {
     ...
     * @param string $user_id
     */
    public function edit(string $user_id): void
    {
    ...
    public function add()
    {
        ...
        try {
            ...
            if (
                ...
                User::save(null, $firstname, $lastname, mb_strtoupper($code), $phone->getNationalNumber(), $email, $pass, $role, null, ((int)Request::post('send_email') === 1));
            }
    ...
    public function save()
    {
        ...
        try {
            ...
            if (
                ...
                User::save($id, $firstname, $lastname, mb_strtoupper($code), $phone->getNationalNumber(), $email, $pass, $role, $photo, ((int)Request::post('send_email') === 1));
            }
