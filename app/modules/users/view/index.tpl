            ...
            <div class="card-body p-1 px-md-4 py-md-3">
                <div class="table-responsive">
                    ...
                    <template id="menuTpl" class="d-none">
                        <div class="d-none d-md-block">
                            <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-title="{#button_view#}" title="{#button_view#}" href="{$ABS_PATH}users/view/:id">
                                <i class="mdi mdi-18px mdi-eye"></i>
                            </a>
                            {if Permissions::has('users_edit')}
                                <a class="btn btn-sm btn-icon btn-secondary disabled" data-bs-toggle="tooltip" data-bs-title="{#button_edit#}" title="{#button_edit#}" href="{$ABS_PATH}users/edit/:id" disabled>
