...
<div class="row">
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="d-flex position-relative align-items-end rounded-top" style="min-height: 150px">
                ...
                <div class="d-flex position-absolute w-100 justify-content-between align-items-center px-2 px-md-4 mt-5 mb-2">
                    ...
                    <div class="d-none d-md-block">
                        <a href="{$ABS_PATH}users/view/{$user.id}" class="btn btn-primary btn-icon-text">
