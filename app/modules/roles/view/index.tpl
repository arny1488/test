                        ...
                        {if $roles}
                            {foreach from=$roles item=role key=key}
                                <tr>
                                    <td class="text-start">
                                        {if $role.editable}
                                            <a title="{#button_edit#}" href="{$ABS_PATH}roles/edit/{$role.id}">
                                                {$role.name}
                                            </a>
                                        {else}
                                            {$role.name}
                                    ...
                                    <td class="text-center py-1">
                                        {if $role.editable}
                                            <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-title="{#button_edit#}" title="{#button_edit#}" href="{$ABS_PATH}roles/edit/{$role.id}">
                                                <i class="mdi mdi-18px mdi-pen"></i>
                                            </a>
                                        {else}
                                            <a class="btn btn-sm btn-icon btn-primary disabled" href="#" disabled>
                                                <i class="mdi mdi-18px mdi-pen"></i>
                                            </a>
                                        {/if}
                                        {if $role.deletable}
                                            <a class="btn btn-sm btn-icon btn-danger" data-confirm="delete" data-bs-toggle="tooltip" data-bs-title="{#button_delete#}" title="{#button_delete#}" href="{$ABS_PATH}roles/delete/{$role.id}">
                                                <i class="mdi mdi-18px mdi-trash-can-outline"></i>
                                            </a>
                                        {else}
                                            <a class="btn btn-sm btn-icon btn-danger disabled" href="#" disabled>
                                                <i class="mdi mdi-18px mdi-trash-can-outline"></i>
                                            </a>
                                        {/if}
                                    </td>
