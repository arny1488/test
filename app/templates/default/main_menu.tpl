    ...
    <div class="container-fluid px-2 px-xl-5">
        <div class="position-relative">
            ...
            <ul class="dropdown-menu mn-wd-200 mx-wd-350">
                <li><a class="dropdown-item" href="{$ABS_PATH}catalog/offers">Предложения</a></li>
                <li><a class="dropdown-item" href="{$ABS_PATH}catalog/categories">Категории</a></li>
                <li><a class="dropdown-item" href="{$ABS_PATH}catalog/brands">Бренды</a></li>
                {* <li><a class="dropdown-item" href="{$ABS_PATH}catalog/holders">Правообладатели</a></li> *}
                <li>
                ...
                <li><span class="small px-3">&copy; {date('Y')}</span></li>
            </ul>
        </div>
        <a class="navbar-brand mx-lg-4" href="{$ABS_PATH}">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    <a class="nav-link" href="{$ABS_PATH}catalog">
                        Каталог
                    </a>
                </li>
            </ul>
            <form class="d-flex w-100 ms-lg-5" role="search" method="get" action="{$ABS_PATH}catalog/offers">
            ...
            <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                ...
                <li class="nav-item ms-lg-4">
                    <a class="nav-link d-flex align-items-center" href="{$ABS_PATH}favorites"><i class="h5 lh-1 bi bi-heart"></i></a>
                </li>
                <li class="nav-item ms-lg-4">
                    <a class="nav-link d-flex align-items-center" href="#"><i class="h5 lh-1 bi bi-bag"></i></a>
                </li>
                {if Settings::get('user_settings', 'organization')}
                    <li class="nav-item ms-lg-4">
                ...
                <li class="nav-item ms-lg-4 dropdown">
                    {if defined('USERID')}
                        ...
                        <ul class="dropdown-menu dropdown-menu-end mn-wd-200 mx-wd-350">
                            <li><a class="dropdown-item" href="{$ABS_PATH}profile"><i class="opacity-50 me-2 mdi mdi-account-circle-outline"></i> Профиль</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><h6 class="dropdown-header">Мои разделы</h6></li>
                            <li><a class="dropdown-item" href="{$ABS_PATH}profile/brands"><i class="opacity-50 me-2 mdi mdi-registered-trademark"></i> Бренды</a></li>
                            <li><a class="dropdown-item" href="{$ABS_PATH}profile/content"><i class="opacity-50 me-2 mdi mdi-image-multiple-outline"></i> Контент</a></li>
                            <li><a class="dropdown-item" href="{$ABS_PATH}profile/offers"><i class="opacity-50 me-2 mdi mdi-tag-multiple-outline mdi-flip-h"></i> Предложения</a></li>
                            <li><a class="dropdown-item" href="{$ABS_PATH}profile/deals"><i class="opacity-50 me-2 mdi mdi-handshake-outline"></i> Сделки</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="{$ABS_PATH}logout"><i class="opacity-50 me-2 mdi mdi-logout"></i> Выйти</a></li>
                        </ul>
                    {else}
                        <a class="nav-link d-flex align-items-center" href="{$ABS_PATH}login"><i class="h4 lh-1 bi bi-person"></i></a>
                    {/if}
                </li>
            </ul>
        </div>
