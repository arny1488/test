...
/* Smarty version {Smarty::SMARTY_VERSION}, created on 2024-07-10 01:33:25
  from "/home/users/a/arny1488/domains/test.oblozhky.ru/app/templates/default/footer.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32-dev-25',
  'unifunc' => 'content_668dbab560d009_91121635',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '35a54670ba00eca76c2228ae8e93ccf078d66ffd' => 
    array (
      0 => '/home/users/a/arny1488/domains/test.oblozhky.ru/app/templates/default/footer.tpl',
      1 => 1705031164,
      2 => 'file',
    ),
  ),
...
function content_668dbab560d009_91121635 (Smarty_Internal_Template $_smarty_tpl) {
?>
<footer class="px-2 px-xl-5 py-3 py-xl-5">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-md-6 col-xl-3 order-md-last mb-5 text-center text-md-start text-xl-end">
                <p class="mb-3">
                    <a class="navbar-brand" href="<?php echo $_smarty_tpl->tpl_vars['ABS_PATH']->value;?>
">
                ...
                <p style="font-variant-numeric: tabular-nums;">8 (800) 500-82-50<br>
                    8 (495) 646-17-08<br>
                    inbox@tm4rent.com</p>
            </div>
            <div class="col-12 col-md-6 col-xl-3 mb-5 text-center text-md-start">
                <p class="h5 text-uppercase">Быстрый переход</p>
            </div>
            <div class="col-12 col-md-6 col-xl-3 mb-5 text-center text-md-start">
                <p class="h5 text-uppercase">Каталог</p>
            </div>
            <div class="col-12 col-md-6 col-xl-3 mb-5 text-center text-md-start" style="font-variant-numeric: tabular-nums;">
                <p>ООО «ТМ4РЕНТ»<br>
                    Юридический адрес:<br>
                    115191, г. Москва, ул. 2-я Рощинская, д. 4, ком. 49</p>
                <table>
                    <tr>
                        <td class="pe-2">ИНН:</td>
                        <td>9725048768</td>
                    </tr>
                    <tr>
                        <td class="pe-2">КПП:</td>
                        <td>772501001</td>
                    </tr>
                    <tr>
                        <td class="pe-2">ОГРН:</td>
                        <td>1217700182039</td>
                    </tr>
                </table>
            </div>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <p class="small">© ООО «ТМ4РЕНТ», <?php echo date('Y');?>
.<br>
                    Все права на любые материалы, опубликованные на сайте, защищены в соответствии с российским и международным законодательством об интеллектуальной собственности.<br>
                    Любое использование графических, текстовых, фото, аудио и видеоматериалов, программных продуктов и иных результатов интеллектуальной деятельности возможно только с согласия правообладателей.</p>
            </div>
        </div>
    </div>
</footer>
